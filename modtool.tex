...
\end{itemize}
Moreover, modtool is only usable as a command line program and isn't available as an API. The basic advantages of building a Python API for the modtool are:-
\begin{itemize}
...
\item Usability of the tool will increase as it will also be scriptable from other Python scripts
\end{itemize}
...
\item \textbf{plugins/\_\_init\_\_.py}: This is the required file to make Python treat the directory as a containing package. Here, it will also be used to set the \_\_all\_\_ variable, i.e., the list of module the package exports as an API.
\\
...
The code can be reviewed as per the proposed time whereas it can be merged according to timeline stated below:
\begin{itemize}
